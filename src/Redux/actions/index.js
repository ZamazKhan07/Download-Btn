  ...
  try {
    ...
    if (response.data.success === true) {
      Swal.fire(
        ...
        html: `OTP code sent successfully to ${registerValues.email}, please check & confirm your
        email.`,
        buttons: false,
        timer: 2000,
        width: 500,
  ...
  try {
    ...
    Swal.fire(
      ...
      // "error",
      {
        icon: 'error',
        title: "Login Failed",
        html: "please double check or change your Password",
        buttons: false,
        timer: 2000,
        width: 400,
        // heightAuto,
  ...
  async (dispatch) => {
    ...
    try {
      ...
      if (response.data.success === true) {
        Swal.fire(
          {
            title: "Product Placed Successfully",
        icon: 'success',
        html: `Thank you! Order successfully placed!`,
        buttons: false,
        timer: 2000,
        width: 400,
        // heightAuto,
