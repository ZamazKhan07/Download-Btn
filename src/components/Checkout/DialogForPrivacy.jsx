...
const DialogForPrivacy = ({
  ...
  const [copyAccTitle, setCopyAccTitle] = useState("");
  const [copyBankName, setCopyBankName] = useState("");
  const [copyAccNumber, setCopyAccNumber] = useState("");
  const [copySwiftCode, setCopySwiftCode] = useState("");
  const [copyRoutingNumber, setCopyRoutingNumber] = useState("");
  const [copyBankAddress, setCopyBankAddress] = useState("");
                  ...
                  <Box sx={{ mt: 5 }}>
                    <Grid container rowGap={1} columnGap={1}>
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copyAccTitle}>
                            <Button
                              variant="contained"
                              onClick={()=>{
                                setCopyAccTitle(bankDetails?.accTitle)
                              }}
                              sx={{
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copyBankName}>
                            <Button
                              variant="contained"
                              onClick={()=>{
                                setCopyBankName(bankDetails?.bankName)
                              }}
                              sx={{
                                // maxWidth: "20px !important",
                                // paddingLeft: "40px",
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copyAccNumber}>
                            <Button
                              variant="contained"
                              onClick={()=>{
                                setCopyAccNumber(bankDetails?.accNumber)
                              }}
                              sx={{
                                // maxWidth: "20px !important",
                                // paddingLeft: "40px",
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copySwiftCode}>
                            <Button
                              variant="contained"
                              onClick={()=>{
                                setCopySwiftCode(bankDetails?.swiftCode)
                              }}
                              sx={{
                                // maxWidth: "20px !important",
                                // paddingLeft: "40px",
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copyRoutingNumber}>
                            <Button
                              variant="contained"
                              onClick={()=>{
                                setCopyRoutingNumber(bankDetails?.routingNumber)
                              }}
                              sx={{
                                // maxWidth: "20px !important",
                                // paddingLeft: "40px",
                      ...
                      <Box
                        ...
                        <Box
                          ...
                          >
                            <CopyToClipboard text={copyBankAddress}>
                              <Button
                              variant="contained"
                              onClick={()=>{
                                setCopyBankAddress(bankDetails?.bankAddress)
                                console.log(copyBankAddress)
                              }}
                              sx={{
                                // maxWidth: "20px !important",
                                // paddingLeft: "40px",
                    ...
                    <Box
                      sx={{
                        marginTop: "15px",
                        background:
                          "linear-gradient(270deg,#00f902 -16.36%,rgba(99, 250, 6, 0) 150%)",
                        border: "1px solid #00f902",
                        borderRadius: "10px",
                        // height: "4rem"
                      }}
                    >
                      <Typography sx={{ mb: 2, mt: 3, textAlign: "center" }}>
                        Your order will be delivered/shipped once the bank
                        transfer is confirmed, An email confirmation will be
                        sent to update your order’s status. Thanks!
                      </Typography>
                      {/* <Box>
