...
const OrderDetails = () => {
  ...
  const handleFetch = async () => {
    ...
    console.log("order tool" , res.data.deliveries);
  };
  ...
  const  subToLocalStorage = () => {
    const isAllFieldsFilled = Object.values(shippingInfo).every(value => value !== "");
    if (isAllFieldsFilled) {
      localStorage.setItem( "user" , JSON.stringify(shippingInfo))
    }
    else {
      alert("Some INputs Field are not filled")
    }
  }
