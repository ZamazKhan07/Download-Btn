...
const FullWidthDialog = styled(Dialog)`
  .MuiDialog-paper {
...
const SingleProduct = () => {
  ...
  const handleClick = (event) => {
    console.log("handleClickAnchorEl")
            ...
            >
              ...
              variant="contained"
                ...
                sx={{
                  ...
                  textTransform: "none",
                  fontSize: "13px",
                  background: "linear-gradient(270deg, #0d0d0d -16.36%, rgba(99, 250, 6, 0) 190%)",
                  borderRadius: "20px",
                  width: "160px"
                }}
              >
              ...
              variant="contained"
                sx={{
                  ...
                  textTransform: "none",
                  background:
                    "linear-gradient(270deg, #ff1514 -16.36%, rgba(99, 250, 6, 0) 190%)",
                  borderRadius: "20px",
                  width: "160px"
                }}
        ...
        {loading ? (
          ...
          >
            ...
            >
              ...
              >
                <Box>
                <Typography sx={{ pl: "10px", fontFamily: "Blinker" }}>
